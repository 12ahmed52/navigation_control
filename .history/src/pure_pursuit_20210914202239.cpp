...
public:
    ...
    ld_calc, arr_x[10000], arr_y[10000], , start_iteration, ld_x, 
    ld_y, alpha, steering_angle, , error;
    int ld_calc_real, end_iteration=100, save_i;
...
public:
  ...
  void publish()
  {
    ...
    void model_k_state_callback(const geometry_msgs::Pose2D::ConstPtr& msg)
    {
        ...
        nav_msg_out.steering_wheel=pure_pursuit_obj.steering_angel;
